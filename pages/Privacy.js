      ...
      <Layout home>
        ...
        <section style={{padding: '2rem'}}>
           <h1>Privacy and Cookies Policy</h1>
                    ...
                    <p> Our website follows the GDPR guidelines as we have obtained explicit and informed consent from users, provided a privacy policy,
                        allowed users to access and delete their data, taken appropriate measures to secure personal data,
                        appointed a DPO (if necessary), notified users of data breaches, and used GDPR-compliant third-party services.
                        We regularly review our website's practices and policies ensure that we remain GDPR-compliant and protect
                        the personal data of our users.</p>
