  ...
  return (
    ...
    <div className='grid-container'>
      ...
      <div className="image1">
         <div style={{marginRight: '720px', justifyContent: 'space-between'}}>
        <img style={{ height: '450px', width: '600px', borderRadius: '10%'}} src="images/web dev.png" alt="Web Development" width="720px" />
       ...
       <div style={{ marginLeft: '600px', justifyContent: 'space-between', marginBottom: '40px'}}>
       <img style={{ height: '400px', width: '800px', borderRadius: '10%'}} src="images/devops.png" alt="DevOps Courses" width="720px" />
       ...
       <div style={{marginRight: '720px', justifyContent: 'space-between'}}>
       <img style={{ height: '450px', width: '600px', borderRadius: '10%'}} src="images/management.png" alt="Management Courses" width="720px" />
