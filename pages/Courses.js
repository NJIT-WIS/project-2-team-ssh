...
export default function Courses() {
  return (
      <Layout home>
        ...
        <div style={{display: 'flex', margin: '1rem', marginBottom : '0px', justifyContent: 'space-between'}}>
    ...
    <div className='grid-container'>
      ...
      <div className="image1">
         <div style={{marginRight: '800px', justifyContent: 'space-between'}}>
        <img style={{ height: '450px', width: '700px', borderRadius: '10%'}} src="images/web dev.png" alt="Web Development" width="720px" />
       ...
       <div style={{ marginLeft: '720px', justifyContent: 'space-between', marginBottom: '40px'}}>
       <img style={{ height: '450px', width: '790px', borderRadius: '10%'}} src="images/devops.png" alt="DevOps Courses" width="720px" />
       ...
       <div style={{marginRight: '800px', justifyContent: 'space-between'}}>
       <img style={{ height: '450px', width: '690px', borderRadius: '10%'}} src="images/management.png" alt="Management Courses" width="720px" />
